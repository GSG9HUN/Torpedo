...
namespace Torpedo.View.pvp_view
{
    ...
    public partial class Pvp2ShipPlacement : Window
    {
        ...
        List<PvpShip> player1Ships = new List<PvpShip>();
        ...
        public Pvp2ShipPlacement(ref Grid[] player1Fields, List<PvpShip> player1Ships, string player1Name, string player2Name)
        {
            ...
            InitializeComponent();
            string tb = player2Name + " seregének összeállítása";
            Who.Text = tb;
            irany = "fel";
            fields = new Grid[]
            {
